...
static public class Scenario
{
    ...
    static public readonly List<MessageData> meslist_day3_gethankati = new List<MessageData>()
    {
        // ハンカチ取得時
    ...
    static public readonly List<MessageData> meslist_day3_timeover = new List<MessageData>()
    {
        // ハンカチ拾えなかった時
    ...
    static public readonly List<MessageData> meslist_day4_gethankati = new List<MessageData>()
    {
        //ハンカチイベント
    ...
    static public readonly List<MessageData> meslist_day4_timeover = new List<MessageData>()
    {
                // 時間切れ
